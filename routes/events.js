...
router.get('/events', authorize, (_req, res, next) => {
  ...
  console.log(date);
  request(`http://api.jambase.com/events?zipCode=98034&radius=50&startDate=${'2016-12-05T19:50:11-08:00'}&page=0&api_key=uazyeq8ba3c3vxa6uewvud2b`, (err, response, body) => {
    if (err) {
